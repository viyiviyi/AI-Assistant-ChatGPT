...
export const Chat = () => {
  ...
  useEffect(() => {
    ...
    setShowConfigs(uiConfig.showConfigPanl === undefined ? false : uiConfig.showConfigPanl);
  }, []);
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
              ...
              <Hidden hidden={screenSize.width < 1200}>
                ...
                >
                  <Button
                    ...
                    icon={showNav ? <MenuUnfoldOutlined /> : <MenuFoldOutlined />}
                  ></Button>
                </div>
              </Hidden>
            ...
            <Hidden hidden={screenSize.width > 1460 ? false : screenSize.width < 1200}>
              <div style={{ position: 'absolute', right: -40, bottom: 10 }}>
                <Button
                  ...
                  icon={showConfigs ? <MenuFoldOutlined /> : <MenuUnfoldOutlined />}
                ></Button>
              </div>
            </Hidden>
          </div>
      ...
      <SkipExport>
        <Modal title={'重要通知'} open={showNotice} centered onCancel={() => setShowNotice(false)} onOk={() => setShowNotice(false)}>
          <MarkdownView
            markdown={`
