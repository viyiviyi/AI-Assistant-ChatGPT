...
const MyDocument = () => (
  <Html lang="zh-cn">
    <Head>
      ...
      <meta
        name="description"
        content="ChatGPT、ChatGLM使用工具，灵活轻便，简洁美观，可完全自由的控制对话上下文，可简单生成远大于token限制的超长文本；可为ChatGPT设定复杂且便于控制的前导提示词，通过简单的勾选，实现超长记忆能力；提升工作效率，解放生产力；文档/对话两种渲染方式，既能模拟聊天，又能用于创作。"
      ></meta>
    </Head>
    <body>
      <Main />
